...
## TODO
- Add a feature to download the contest ZIP files straight from the UIL website
- Add a timer to simulate
- Have user code live in a "src/" directory to not pollute working dir
- copy student data files to "src/" directory